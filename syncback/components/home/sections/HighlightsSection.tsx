    ...
    >
      <div className="grid gap-6 md:grid-cols-3">
        {highlights.map(({ icon: Icon, title, description }) => (
          <div
            key={title}
            className="group flex h-full flex-col justify-between gap-6 rounded-[28px] border border-white/50 bg-white/90 p-10 text-left shadow-[0_0_30px_rgba(0,0,0,0.08)] transition duration-500 hover:-translate-y-1 hover:border-slate-200 hover:bg-white dark:border-slate-700/70 dark:bg-slate-900/80 dark:shadow-slate-900/40 dark:hover:border-slate-600"
          >
